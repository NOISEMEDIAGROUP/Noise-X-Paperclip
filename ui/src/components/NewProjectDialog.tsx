...
export function NewProjectDialog() {
  ...
  async function handleSubmit() {
    ...
    if (localRequired && !isAbsolutePath(localPath)) {
      setWorkspaceError("本地文件夹必须使用完整绝对路径。");
      return;
    }
    ...
    >
      ...
      >
        ...
        <div className="px-4 pb-3 space-y-3 border-t border-border">
          <div className="pt-3">
            <p className="text-sm font-medium">该项目的工作将在何处进行？</p>
            <p className="text-xs text-muted-foreground">添加本地目录和/或 GitHub 仓库作为工作区提示。</p>
          </div>
          <div className="grid gap-2 sm:grid-cols-3">
            ...
            >
              ...
              <p className="mt-1 text-xs text-muted-foreground">请使用当前机器上的完整绝对路径。</p>
            </button>
            <button
              type="button"
              className={cn(
            ...
            >
              ...
              <p className="mt-1 text-xs text-muted-foreground">粘贴一个 GitHub URL。</p>
            </button>
            <button
              type="button"
              className={cn(
            ...
            >
              ...
              <p className="mt-1 text-xs text-muted-foreground">配置本地目录与仓库提示。</p>
            </button>
          </div>
            ...
            <div className="rounded-md border border-border p-2">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  placeholder="/完整/绝对/路径/workspace"
                />
                <ChoosePathButton />
              </div>
            </div>
