        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <CardDescription className="text-xs mt-0.5">
              <span className="font-mono">{formatTokens(totalInputTokens)}</span> {t("in_tokens")}
              {" · "}
              <span className="font-mono">{formatTokens(totalOutputTokens)}</span> {t("out_tokens")}
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                <span className="font-mono text-foreground">{totalSubRuns}</span> {t("runs_label")}
                {" · "}
                {totalSubTokens > 0 && (
                  <>
                ...
                <span className="font-mono text-foreground">{formatTokens(totalSubInputTokens)}</span> {t("in_tokens")}
                {" · "}
                <span className="font-mono text-foreground">{formatTokens(totalSubOutputTokens)}</span> {t("out_tokens")}
              </p>
              {subSharePct > 0 && (
                <>
