...
interface PluginConfigFormProps {
  ...
  isLoading?: boolean;
  /** Current plugin lifecycle status — t("Test Configuration") only available when `ready`. */
  pluginStatus?: string;
...
/**
 * Inner component that manages form state, validation, save, and t("Test Configuration")
